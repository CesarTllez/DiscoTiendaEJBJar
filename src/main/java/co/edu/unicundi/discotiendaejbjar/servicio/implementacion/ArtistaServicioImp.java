...
public class ArtistaServicioImp implements IArtistaServicio {
    ...
    /**
     * Método que comprueba si el id existe, si es así, busca el artista con
     * dicho id.
     *
     * @param id
     * @return
    ...
    /**
     * Método que comprueba si el nombre no están registrado con otro artista,
     * si es así, permite efectur el registro.
     *
     * @param objeto
     */
    @Override
    ...
    /**
     * Método que comprueba si el id existe y el nombre no está registrado con
     * otro artista, si es así, permite modificar al artista.
     *
     * @param objeto
     */
    @Override
     ...
     * eliminar al artista por dicho id.
     *
     * @param id
     */
    @Override
